...
### 📥 [تحميل مباشر — QuantumCommercePro-Setup-v1.5.0.exe](https://github.com/abdelmajidgamer96-tech/quantum-commerce-releases/releases/download/V1.5.0/QuantumCommercePro-Setup-v1.5.0.exe)

**مجاني للتجربة — بدون أي تواصل مسبق، وبدون أي مفتاح تفعيل.**

</div>

> **النسخة المجانية:** ثبّت وابدأ الاستخدام فوراً — حتى 25 منتج و10 فواتير (سقف دائم، وليس شهرياً). تعمل بالكامل أوفلاين ولا تنتهي بمدة زمنية، فقط بهذين الحدين.

لما تحتاج تتجاوز هذي الحدود (أو تبي دعماً فنياً وتدريباً)، فعّل ترخيص كامل:

<div align="center">

| الخطوة | الوصف | الرابط |
|-------|-------|--------|
| 🎬 عرض تجريبي مباشر | نُريك المنصة والكاشير قبل أي قرار شراء | [تواصل عبر واتساب](https://wa.me/213791140239) |
| 💬 طلب مفتاح تفعيل وشراء الترخيص | إزالة حدود النسخة المجانية نهائياً | [واتساب](https://wa.me/213791140239) |
...
|-------|-------|-------|--------|
| QCP-STORE | ترخيص متجر منفرد مدى الحياة (دفعة واحدة) | 45,000 دج (≈ $180) | ✅ متاح |
...
- **تحذير عند نفاد المخزون** بدل السماح ببيع صامت لكمية غير متوفرة
- **إصلاح حساب الضريبة** — كان يُحتسب حتى بعد إيقافه من الإعدادات
- **منع تكرار حفظ نفس البيعة** عند الضغط أكثر من مرة على زر الدفع
- اختصار لوحة المفاتيح F2 لإتمام الدفع أصبح يعمل فعلياً
- حدود واضحة لباقة الاستخدام المجاني (100 منتج / 50 فاتورة شهرياً)
- تحذير عند قراءة فاتورة بعملة مختلفة عن عملة متجرك بالذكاء الاصطناعي
